...
def volumize_gt(image_b, pose2_b, pose3_b, resize_factor, im_resize_factor, \
	...
	for ii in xrange(num_of_data):
		im_ = misc.imresize(image_b[ii],(resize_factor,im_resize_factor))
		...
		volume_b = np.empty((0,resize_factor,resize_factor))
		...
		for jj in xrange(14):
			...
			volume_b = np.concatenate((volume_b,vol_joint))
			#vol_joint_ += vol_joint
		#plot_3d(vol_joint_)
		batch_data.append(volume_b)
		pose2.append(p2_)
		pose3.append(p3_)
		image.append(im_)
